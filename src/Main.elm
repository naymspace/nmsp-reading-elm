...
manifest =
    ...
    , description = "naymspace internal reading list"
    , iarcRatingId = Nothing
    , name = "nmsp reading"
    , themeColor = Just Color.white
    , startUrl = pages.index
    , shortName = Just "nmsp reading"
                ...
                , label =
                    Element.row [ Font.size 30, Element.spacing 16 ]
                        [ Element.image
                            ...
                            { src = ImagePath.toString Pages.images.icon, description = "Naymspace Icon" }
                        , Element.text "nmsp reading"
                        ]
                }
    ...
    case metadata of
        ...
        Metadata.Author meta ->
            ...
            Seo.summary
                ...
                , image =
                    { url = meta.avatar
                    , alt = meta.name ++ "'s nmsp reading articles."
                    , dimensions = Nothing
                    , mimeType = Nothing
                    }
                , description = meta.bio
                , locale = Nothing
                , title = meta.name ++ "'s nmsp reading articles."
                }
                |> Seo.profile
                    { firstName = firstName
                    , lastName = lastName
        ...
        Metadata.BlogIndex ->
            Seo.summaryLarge
                ...
                , image =
                    { url = images.iconPng
                    , alt = "nmsp reading logo"
                    , dimensions = Nothing
                    , mimeType = Nothing
                    }
                , description = siteTagline
                , locale = Nothing
                , title = "nmsp reading blog"
                }
                |> Seo.website
...
canonicalSiteUrl =
    "https://naymspace.github.io/nmsp-reading/"
...
githubRepoLink =
    Element.newTabLink []
        { url = "https://github.com/naymspace"
        , label =
            Element.image
